...
|B|||||
|-|-|-|-|-|
| BEGIN_OF    |BUILD_CALL      |BUILD_EVENT   |BUILD_PROCEDURE|BUILD_WINDOW    |
| BIT_SIZE    |BUILD_CONDITION |BUILD_FUNCTION|BUILD_PROGRAM  |BUILD_WITH_ERROR|
| BREAK       |BUILD_CONGLOM   |BUILD_METHOD  |BUILD_RANGE    |BUILD_WITH_UNITS|
| BSEARCH     |BUILD_DEPENDENCY|BUILD_OPAQUE  |BUILD_ROUTINE  |BUILTIN_OPCODE  |
| BTEST       |BUILD_DIM       |BUILD_PARAM   |BUILD_SIGNAL   |BYTE            |
| BUILD_ACTION|BUILD_DISPATCH  |BUILD_PATH    |BUILD_SLOPE    |BYTE_UNSIGNED   |
