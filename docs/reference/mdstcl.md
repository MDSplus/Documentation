# MDSTCL (MDSplus Tree Command Language) Commands
...
### `compress treename [/shot=shot-number]`
...
* **Description**: The SET VIEW command is used to set the time context for examining
